...
with DAG(
    ...
    bsc_daily_trace_indexing_tasks = []
    ...
    for hour in range(24):
        ...
        bsc_daily_trace_indexing_tasks.append(KubernetesPodOperator(
    ...
    bsc_daily_trace_indexing_tasks >> merge_objects >> rename_merged_object
