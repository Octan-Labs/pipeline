...
with DAG(
        dag_id='import_from_s3_to_clickhouse_by_date',
    ...
    @task(task_id="import_from_s3_to_clickhouse_by_date")
    def import_from_s3_to_clickhouse_by_date(ds=None, **context):
    ...
    import_from_s3_to_clickhouse_by_date_task = import_from_s3_to_clickhouse_by_date()
    import_from_s3_to_clickhouse_by_date_task