...
env_vars = [
    k8s.V1EnvVar(name='START', value="{{ data_interval_start.subtract(days=10, minutes=1)}}"),
    k8s.V1EnvVar(name='END', value="{{ data_interval_start.subtract(days=10, minutes=1)}}"),
