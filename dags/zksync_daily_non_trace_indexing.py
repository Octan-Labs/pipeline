...
with DAG(
    'zksync_daily_non_trace_indexing',
    default_args=default_args,
    description='Run zksync indexer daily',
    schedule="10 0 * * *",
    catchup=False,
    tags=['zksync']
) as dag:
    ...
    KubernetesPodOperator(
            ...
            name='zksync_non_trace_index',
            task_id='zksync_non_trace_index',
