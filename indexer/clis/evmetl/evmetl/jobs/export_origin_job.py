...
from evmetl.mappers.origin_mapper import OriginMarketplaceListingMapper, OriginShopProductMapper
from evmetl.service.origin_extractor import OriginEventExtractor
