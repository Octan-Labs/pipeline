DROP TABLE IF EXISTS labeling_bnb_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_eth_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_arb_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_matic_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_aurora_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_xrp_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_trx_addresses;
...
ORDER BY (address);
DROP TABLE IF EXISTS labeling_base_addresses;
